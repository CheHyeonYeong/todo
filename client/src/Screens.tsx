...
function StudyPlanner({ store }: { store: Store }) {
  const [weekOffset, setWeekOffset] = useState(0); const start = startOfWeek(); start.setDate(start.getDate() + weekOffset * 7);
