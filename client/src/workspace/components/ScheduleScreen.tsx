...
import { sessionDurationMs, totalDurationMs } from "../../time/model/sessionRules";
      ...
      {grouped.map(([day, sessions]) => (
        <Card key={day}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.chip}>총 {Math.round(totalDurationMs(sessions) / 60000)}분</Text>
          </View>
          {[...sessions]
              ...
              <View key={session.id} style={styles.listRow}>
                <View style={styles.flex}>
                  ...
                  <Text style={styles.meta}>
                    ...
                    · {Math.max(1, Math.round(sessionDurationMs(session) / 60000))}분
                  </Text>
                </View>
