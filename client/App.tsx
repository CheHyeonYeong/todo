  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="dark" />
    <View style={desktop ? styles.desktopShell : styles.mobileShell}>
      ...
      <View style={styles.mainColumn}>
        ...
        <View style={[styles.content, desktop && styles.desktopContent]}>{store.loading ? <ActivityIndicator style={styles.loader} color="#176b47" /> : workspace === "todo" ? <TodoScreen store={store} /> : workspace === "memo" ? <MemoScreen store={store} /> : workspace === "timer" ? <TimerScreen store={store} /> : <ScheduleScreen store={store} />}</View>
        {!desktop && navigation}
      </View>
    </View>
  </SafeAreaView>;
